...
The user-provided dataset remains in the local `funscript-tests` folder.
Pass its location through a `--dataset` argument; do not embed a personal
home-directory path in code, reports, or published documentation.
