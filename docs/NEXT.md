...
| 3 | Improve automatic two-ROI suggestions | **Open** — `find_two_rois` not wired (measured insufficient); **direction shift:** everyday path should be no-mark 4-zone / profile feel, not dual-ROI recognition — see `docs/TFTJ_PROFILE_DIRECTION.md` |
| 4 | Motion-signature/profile GUI | **Done** |
| 5 | Contact-triggered vibration Tf/Tj | **Done** (opt-in); **next:** promote into Normal + Auto per `TFTJ_PROFILE_DIRECTION.md` |
