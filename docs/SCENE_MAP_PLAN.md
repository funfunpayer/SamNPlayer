...
Status: **P5a done** (#255 / `c57b910`) — P4b #254; P4 #253; P3 #251; P2 v0.5.31; P1 #246; plan #243.
Implementation: Cursor (per Owner). Claude reviews the engine parts and runs
the golden-clip measurements. **Next: P5b** GUI Collect/Delete/Export (this PR),
then Claude M3 gate / Owner rhythm clips before P6.
