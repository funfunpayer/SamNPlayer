...
| **B5** | **Interactive “mark what matters / what not” on a first pass** | Track-Anything *UX idea* (click/paint regions), not the SAM stack | SceneMap **P2** exclude/source/region marks — Advanced only | Owner § 6 (time scope, learning default) |
