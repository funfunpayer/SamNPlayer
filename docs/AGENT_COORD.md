...
| 23 Sep | **Face** #223: README + website + Create/Play screenshots → Emotion Generator / Emotion Script / v0.5.27; sync-public-site also copies guides/blog/faq. Ready for review. Showcase push = owner (agent 403). Cursor stays off Claude CSRT drift Go core | Cursor |
