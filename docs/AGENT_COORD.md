...
<<<<<<< HEAD
=======
| BookmarksUI | Cursor | THIS | **Play bookmarks** — wire Get/SaveScriptBookmarks (add/seek/remove) | **THIS** |
>>>>>>> d804bf8 (feat(play): wire bookmarks add/seek/remove in Emotion GUI)
...
=======
| Engine | — | free | Look2+GuiLoad+AIWrite+GapHeal+Refine on main; **BookmarksUI THIS**; Owner gates unchanged | **OPEN** |
>>>>>>> d804bf8 (feat(play): wire bookmarks add/seek/remove in Emotion GUI)
...
=======
- **Shipped:** Look2 [#259](https://github.com/funfunpayer/SamNPlayer/pull/259); GuiLoad [#260](https://github.com/funfunpayer/SamNPlayer/pull/260); AIWrite S0 [#261](https://github.com/funfunpayer/SamNPlayer/pull/261); GapHeal [#262](https://github.com/funfunpayer/SamNPlayer/pull/262); Refine [#263](https://github.com/funfunpayer/SamNPlayer/pull/263).
- **In flight:** **BookmarksUI** THIS — Play wires Get/SaveScriptBookmarks (add/seek/remove).
>>>>>>> d804bf8 (feat(play): wire bookmarks add/seek/remove in Emotion GUI)
