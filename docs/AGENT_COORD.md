...
| T-clip | Claude | [#215](https://github.com/funfunpayer/SamNPlayer/pull/215) | **Training mosaic frames** from full clip **2:14–2:40**; 24 frames | **DONE** |
| TrainS | Claude | [#216](https://github.com/funfunpayer/SamNPlayer/pull/216) | Training suction / elevated channel end ramp | **NEXT** — Claude (do not steal; rebase conflicts) |
