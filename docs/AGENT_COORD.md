...
| SceneP3 | Cursor | `cursor/scenemap-p3-95d8` → PR TBD | **SceneMap P3** — engine honours marks (candidate filter, Go masks+rhythm grid, camera multi-exclude) | **DONE** (PR TBD) |
...
| Engine | — | free | SceneMap P3 landed (PR TBD); next = Claude M3 gate / P4 `.samn` / G1.1 after Owner gates | **OPEN** |
...
- **In flight:** SceneMap **P3** engine consume marks (`cursor/scenemap-p3-95d8`, PR TBD) — Claude measures M3 gate.
